...
Tsb = FKinSpace(M, Slist, thetalist);  % Finds current EE position

Vs = Adjoint(Tsb) * se3ToVec(MatrixLog6(TransInv(Tsb) * T)); %Finds change required to get to new T maybe
